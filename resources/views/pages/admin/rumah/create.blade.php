...
<div class="container-fluid py-4">
    ...
    <div class="page-header mb-4">
        <h2 class="fw-bold">Tambah Data Rumah</h2>
        <p class="text-muted">Tambahkan data rumah baru</p>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="form-card bg-white shadow-sm p-4 rounded-3">
                ...
                <form id="formRumah" action="{{ route('admin.rumah.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="nomor_rumah" id="nomor_rumah"
                                   ...
                                   value="{{ old('nomor_rumah') }}" required min="1">
                        </div>
                    ...
                    <div class="mt-4">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="tambah_penghuni"
                                   name="tambah_penghuni" value="1" checked>
                            <label class="form-check-label" for="tambah_penghuni">
                                <strong>Langsung tambah penghuni</strong> setelah menyimpan data rumah
                            </label>
                        </div>
                        <small class="text-muted">Kosongkan jika ingin kembali ke daftar rumah.</small>
                    </div>

                    {{-- Tombol --}}
                    <div class="d-flex gap-2 mt-4 pt-3 border-top">
                        <a href="{{ route('admin.rumah.index') }}" class="btn btn-light border">
