                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="card-rumah">
                                <div class="card-rumah-body">
                                    ...
                                    {{-- ⭐ BAGIAN PENGHUNI BARU --}}
                                    <div class="mb-2">
                                        <small class="text-muted d-block">Penghuni</small>

                                        @if ($r->penghuniAktif->count() > 0)
                                            <div class="penghuni-list">
                                                @foreach ($r->penghuniAktif as $penghuni)
                                                    <div class="penghuni-item">
                                                        <div class="penghuni-info">
                                                            <div class="penghuni-nama">{{ $penghuni->warga->nama_lengkap }}
                                                            </div>
                                                            <div class="penghuni-status">{{ $penghuni->status_penghuni }}
                                                            </div>
                                                        </div>
                                                        <form action="{{ route('admin.penghuni.destroy', $penghuni->id) }}"
                                                            method="POST" class="form-hapus-penghuni d-inline">
                                                            @csrf @method('DELETE')
                                                            <button type="submit" class="btn-hapus-penghuni"
                                                                title="Hapus Penghuni"
                                                                data-nama="{{ $penghuni->warga->nama_lengkap }}">
                                        ...
                                        <a href="{{ route('admin.rumah.penghuni.create', $r->id) }}"
                                            class="btn btn-sm btn-outline-info btn-tambah-penghuni">
                                    ...
                                    @if ($r->gambar)
                                        <button type="button"
                                            class="btn btn-sm btn-outline-primary w-100 open-modal-gambar mb-2"
    ...
    <script>
        ...
        document.querySelectorAll('.open-modal-gambar').forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                Swal.fire({
                    title: `Gambar Rumah ${nomorRumah}`,
                    imageUrl: gambarUrl,
                    imageAlt: `Foto Rumah ${nomorRumah}`,
                    width: '80%',
