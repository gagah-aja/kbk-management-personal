                            ...
                            <div class="mt-3 d-flex flex-wrap gap-2">
                                ...
                                <div class="d-flex gap-2 w-100">
                                    ...
                                    <form action="{{ route('admin.rumah.destroy', $r->id) }}" method="POST" class="flex-fill">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-outline-danger btn-sm w-100" onclick="return confirm('Yakin ingin menghapus rumah ini?')">
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-center">
                                    <img src="{{ asset('storage/'.$r->gambar) }}" class="img-fluid rounded mb-3" alt="Gambar Rumah">
                                </div>
                                <div class="modal-footer justify-content-end">
                                    <a href="{{ asset('storage/'.$r->gambar) }}" target="_blank" class="btn btn-primary btn-sm">
