            ...
            <form action="{{ route('admin.warga.index') }}" method="GET">
                <div class="input-group">
                    ...
                    <input type="text" name="search" class="form-control border-start-0"
                        placeholder="Cari nama, NIK, atau no telepon..." value="{{ $search ?? '' }}">
                                        ...
                                        <div class="me-3">
                                            @if ($warga->foto)
                                                <img src="{{ asset('storage/' . $warga->foto) }}"
                                                    alt="{{ $warga->nama_lengkap }}" class="rounded-circle"
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="text-muted">
                                                ...
                                                @if ($warga->jenis_kelamin == 'Laki-laki')
                                                    <span class="badge bg-info ms-2"><i class="bi bi-gender-male"></i>
                                                        L</span>
                                                @else
                                                    <span class="badge bg-danger ms-2"><i class="bi bi-gender-female"></i>
                                                        P</span>
                                                @endif
                                            </small>
                                        </div>
                                            ...
                                            <div class="detail-section">
                                                ...
                                                <div class="detail-grid">
                                                    ...
                                                    <div class="detail-item">
                                                        ...
                                                        <span
                                                            class="detail-value">{{ \Carbon\Carbon::parse($warga->tanggal_lahir)->format('d/m/Y') }}</span>
                                                    </div>
                                                    <div class="detail-item">
                                            ...
                                            @if ($warga->foto_ktp)
                                                <div class="detail-section">
                                                    ...
                                                    <img src="{{ asset('storage/' . $warga->foto_ktp) }}"
                                                        alt="KTP {{ $warga->nama_lengkap }}" class="img-thumbnail"
                                            ...
                                            <div class="detail-section">
                                                ...
                                                <div class="detail-grid">
                                                    ...
                                                    <div class="detail-item">
                                                        ...
                                                        <span
                                                            class="detail-value">{{ $warga->rumah->alamat ?? '-' }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="detail-section">
                                                ...
                                                <div class="detail-grid">
                                                    <div class="detail-item">
                                                        ...
                                                        <span
                                                            class="detail-value">{{ $warga->pendidikan_terakhir ?? '-' }}</span>
                                                    </div>
                                                    <div class="detail-item">
