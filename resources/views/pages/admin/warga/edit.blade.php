                    ...
                    <div class="form-card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <img id="preview_foto"
                                     src="{{ $warga->foto ? asset('storage/'.$warga->foto) : '' }}"
                    ...
                    <div class="form-card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <select name="id_rumah" id="id_rumah"
                                        class="form-select @error('id_rumah') is-invalid @enderror">
                                    <option value="">-- Pilih Rumah --</option>
                                    @foreach($rumahList as $r)
                                        <option value="{{ $r->id }}"
                                            {{ old('id_rumah',$warga->id_rumah)==$r->id?'selected':'' }}>
                                            {{ $r->alamat_lengkap }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('id_rumah') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <select id="pendidikan_terakhir" name="pendidikan_terakhir"
                                    ...
                                    @foreach(['SD','SMP','SMA','D3','S1','S2','S3'] as $p)
                                        <option value="{{ $p }}" {{ old('pendidikan_terakhir',$warga->pendidikan_terakhir)==$p?'selected':'' }}>
                                            {{ $p }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="gaji" name="gaji"
                                           ...
                                           value="{{ old('gaji', number_format($warga->gaji,0,',','.')) }}"
                                           placeholder="0">
                                </div>
...
{{-- SCRIPT PREVIEW FOTO --}}
<script>
function previewFoto(e){ let p=document.getElementById('preview_foto'); p.src=URL.createObjectURL(e.target.files[0]); p.style.display='block'; }
function previewKTP(e){ let p=document.getElementById('preview_ktp'); p.src=URL.createObjectURL(e.target.files[0]); p.style.display='block'; }
</script>
...
.form-card-header{
    ...
    color:#fff;padding:.875rem 1.25rem;font-weight:600;
    border-radius:12px 12px 0 0;font-size:.95rem;
}
